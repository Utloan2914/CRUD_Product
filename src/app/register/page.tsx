                ...
                <CardBody>
                    <Row>
                        <Col md='10' lg='6' className='order-2 order-lg-1 d-flex flex-column align-items-center'>
                            ...
                            <form onSubmit={handleSubmit} className='d-flex flex-column align-items-center'>
                                ...
                                <div className="d-flex flex-row align-items-center mb-4">
                                    ...
                                    <Input type={showRepeatPassword ? 'text' : 'password'} name='repeatPassword' placeholder='Nhập lại mật khẩu' value={formData.repeatPassword} onChange={handleChange} />
                                    <i
                                        className={`fas ${showRepeatPassword ? 'fa-eye-slash' : 'fa-eye'} me-3`}
                                ...
                                <Button type="submit" id="button" className='mb-4' size='lg'>Đăng ký</Button>
                            </form>
                        </Col>
                        ...
                        <Col md='10' lg='6' className='order-1 order-lg-2 d-flex align-items-center'>
                            {formData.urlImage && (
                                <CardImg src={formData.urlImage} fluid />
                            )}
                        </Col>
